    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new NoteAdapter.OnItemClickListener(){
            @Override
                ...
                intent.putExtra(AddNoteActivity.EXTRA_TITLE, note.getId());
                intent.putExtra(AddNoteActivity.EXTRA_TITLE, note.getTitle());
                intent.putExtra(AddNoteActivity.EXTRA_TITLE, note.getDescription());
                intent.putExtra(AddNoteActivity.EXTRA_TITLE, note.getPriority());
